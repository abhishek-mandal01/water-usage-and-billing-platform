...
function Sidebar({ restricted = false }) {
  ...
  const fullMenus = [
    { title: "Dashboard", path: "/community/dashboard", icon: Speedometer2 },
    { title: "Residents", path: "/community/residents", icon: PeopleFill },
    { title: "Apartments", path: "/community/apartments", icon: Building },
    { title: "Water Usage", path: "/community/meter", icon: DropletFill },
    {
      title: "Water Purchase",
      path: "/community/water-purchase",
      icon: BoxSeamFill,
    },
    { title: "Billing", path: "/community/billing", icon: ReceiptCutoff },
    {
      title: "Alerts",
      path: "/community/alerts",
      icon: ExclamationTriangleFill,
    },
    { title: "Reports", path: "/community/reports", icon: BarChartFill },
    { title: "Settings", path: "/community/settings", icon: GearFill },
  ];

  // While pending approval, only Dashboard is reachable - everything
  // else is locked until a Super Admin approves the account.
  const menus = restricted
    ? [{ title: "Dashboard", path: "/community/dashboard", icon: Speedometer2 }]
    : fullMenus;
    ...
    <>
      <aside className="wm-sidebar">
        ...
        <div className="wm-sidebar-footer">
          <span className="wm-role-badge">Community Admin</span>
